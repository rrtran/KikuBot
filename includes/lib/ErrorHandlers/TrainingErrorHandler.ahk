...
LaunchGame()
{
	global ALLYPENDINGREQUEST_TEXT, ANNOUNCEMENT_BUTTON, ALLY_TEXT, BACK_BUTTON, MYPAGEID_TEXT, MYPAGEID2_TEXT, QUEST1_ICON, QUEST2_ICON, SELECTEPISODE_BUTTON
	global SLEEPTIME, STARTGAME_BUTTON, TRAINING_TEXT, TRAINING1_ICON, TRAINING2_ICON, TRAINING3_ICON, MAYBELATERADVERTISEMENT_BUTTON, CANCELADVERTISEMENT_BUTTON
	...
	if (borderColor <> 0x000000)
	{
		...
		while not DetectObject(TRAINING_TEXT)
		{
			Sleep 10000
			ConnectionError()
			...
			else if DetectObject(TRAINING1_ICON)
			{
				WaitObject(TRAINING1_ICON)
				ClickObject(TRAINING1_ICON)
			}
			else if DetectObject(TRAINING2_ICON)
			{
				WaitObject(TRAINING2_ICON)
				ClickObject(TRAINING2_ICON)
			}
			else if DetectObject(TRAINING3_ICON)
			{
				WaitObject(TRAINING3_ICON)
				ClickObject(TRAINING3_ICON)
			}
		}
		Return 1
	}
